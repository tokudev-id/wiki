---
title: Arsitektur dan DDD
description: Panduan arsitektur Clean Architecture dan Domain-Driven Design (DDD) untuk aplikasi .NET di Unictive, mencakup struktur folder, entities, value objects, aggregates, dan CQRS dengan MediatR.
published: true
